  ...
  return (
    <main className="mx-auto max-w-5xl px-6 py-12">
      <header className="space-y-4">
        ...
        <h1 className="text-3xl font-semibold tracking-tight sm:text-4xl">Ship SaaS faster</h1>
        <p className="max-w-2xl text-muted-foreground">A starter that enforces clean boundaries, real auth, and production DB workflows from day one.</p>
