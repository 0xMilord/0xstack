export type GlobalsTheme = "default" | "corporate-blue" | "amber" | "grass";

export const GLOBALS_CSS_THEMES: Record<GlobalsTheme, string> = {
...
`,
  ...
  "corporate-blue": `@import "tailwindcss";
...
// Back-compat
export const REQUIRED_GLOBALS_CSS = GLOBALS_CSS_THEMES.default;
